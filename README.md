...
```javascript
FLOAT16_LOG10E = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/constants-float16-log10-e@v0.1.1-umd/browser.js' )
```
...
[test-image]: https://github.com/stdlib-js/constants-float16-log10-e/actions/workflows/test.yml/badge.svg?branch=v0.1.1
[test-url]: https://github.com/stdlib-js/constants-float16-log10-e/actions/workflows/test.yml?query=branch:v0.1.1
